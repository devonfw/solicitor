...
"readers" : [ {
      ...
      "usagePattern" : "DYNAMIC_LINKING"
      "repoType" : "maven" //or npm or pip or .NET
   	} ]
----
...
NOTE: In the "repoType" field, only ONE type is allowed to be set. In case the SBOM contains packages of multiple types, create a seperate SBOM and reader configuration for each type.
