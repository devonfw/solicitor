...
== Release Notes
Changes in 1.15.0::
* https://github.com/devonfw/solicitor/issues/208: Add a new lifecycle method which is called after the model is processed but before the reports are generated.
