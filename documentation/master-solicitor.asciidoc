...
== Release Notes
Changes in 1.43.0::
* Removed deprecated Reader for NPM License Crawler data.
* Removed deprecated 'gradle2' Reader. 
* Removed deprecated REGEX prefix notation in decision tables.
...
* https://github.com/devonfw/solicitor/pull/333: Finally dropping support for running on Java versions prior to Java 17. Updating Spring Boot to version 3. Updating several other dependencies. Undo of no longer needed workaround introduced with
https://github.com/devonfw/solicitor/pull/31. Supported Java versions are 17 to 25.
