...
| dataStatus | String |  It represents the status of the data associated with the component.
| traceabilityNotes | String |  It provides traceability notes related to the component.
|===
