...
* https://github.com/devonfw/solicitor/issues/299: Restructuration of PackageURLHandler class structure and processing to better handle PackageURL types for which no specific SingleKindPackageURLHandler is defined. This might result in PackageURLs to be processed which were ignored until now.
