...
== Release Notes
Changes in 1.43.0::
* https://github.com/devonfw/solicitor/pull/333: Finally dropping support for running on Java versions prior to Java 17. Updating Spring Boot to version 3. Updating several other dependencies. Supported Java versions are 17 to 25.
