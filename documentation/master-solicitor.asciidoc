...
== Release Notes
Changes in 1.26.0::
* https://github.com/devonfw/solicitor/pull/273: Refactoring of the  Scancode pasrsing (class FilteredScancodeComponentInfoProvider) to read Scancode files of version 32.x
* https://github.com/devonfw/solicitor/issues/276: Refactor parsing scancode
