...
* Use of `repoType` in _solicitor.cfg_. Value will be set via `packageUrl`; Stage 1 from Version 1.14.0 on; see https://github.com/devonfw/solicitor/issues/190
...
* https://github.com/devonfw/solicitor/issues/190: Deprecate `repoType` attribute.
