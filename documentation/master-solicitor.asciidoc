...
== Release Notes
Changes in 1.43.0::
This is a maintenance release which focusses on the reducing technical debt by removing deprecated features
and updating used frameworks and libraries to up-to-date versions. Supported Java versions are 17 to 25.
...
* https://github.com/devonfw/solicitor/pull/333: Finally dropping support for running on Java versions prior to Java 17. Updating Spring Boot to version 3. Updating several other dependencies.
* Undo of no longer needed workaround introduced with https://github.com/devonfw/solicitor/pull/31.
