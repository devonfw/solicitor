...
* https://github.com/devonfw/solicitor/pull/235: Enhanced Curation Template Generation.  when generating a curation template and setting the curationdataselector parameter to "none," curations will be skipped, resulting in a template without applied curations.
