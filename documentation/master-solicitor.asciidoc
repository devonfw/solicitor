...
<10> A single path prefix. All scanned files starting with this path prefix are excluded from the Scancod information.
...
== Release Notes
Changes in 1.15.0::
* Add a new feature allowing the exclusion of paths and files of scanned artifacts from the Scancode information.
Changes in 1.14.0::
