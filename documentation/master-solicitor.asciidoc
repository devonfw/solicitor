...
| dataStatus | String |  Represents the quality status of the data associated with the component. It indicates the reliability, accuracy, and completeness of the information related to the component. Possible values may include "Validated", "Incomplete", "Outdated", "Unverified", "Verified", or other relevant categories depending on the specific context and requirements.  
| traceabilityNotes | String |   Provides traceability notes related to the component. These notes offer insights into various aspects of the component, including its source and origin, version changes, integration details, licensing information, contributors, compatibility, and change history.
|===
...
== Release Notes
Changes in 1.12.0::
* https://github.com/devonfw/solicitor/pull/183: Extension of the data structure "ComponentInfo" and "ScancodeComponentInfo" in Solicitor
* https://github.com/devonfw/solicitor/issues/182: Addition new data quality and traceability attributes to the ComponentInfo data structure.
