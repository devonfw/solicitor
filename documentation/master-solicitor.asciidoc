...
== Release Notes
Changes in 1.43.0::
This is a maintenance release which focusses on reducing technical debt by updating used frameworks/libraries to up-to-date versions and removing deprecated features. Supported Java versions are 17 to 25.
