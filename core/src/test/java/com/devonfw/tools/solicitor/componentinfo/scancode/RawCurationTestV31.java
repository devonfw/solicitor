 ...
 * {@link FilteredScancodeV31ComponentInfoProvider} class.
 */

public class RawCurationTestV31 {

  // the object under test
  FilteredScancodeV31ComponentInfoProvider filteredScancodeComponentInfoProvider;
  ...
  public void setup() {
    ...
    this.filteredScancodeComponentInfoProvider = new FilteredScancodeV31ComponentInfoProvider(
        this.fileScancodeRawComponentInfoProvider, this.singleFileCurationProvider);

    this.fileScancodeRawComponentInfoProvider.setScancodeFileName("scancodeV31.json");
  }

  /**
   * Test the
   * {@link FilteredScancodeV31ComponentInfoProvider#getComponentInfo(String, com.devonfw.tools.solicitor.componentinfo.CurationDataHandle)}
   *
   *
