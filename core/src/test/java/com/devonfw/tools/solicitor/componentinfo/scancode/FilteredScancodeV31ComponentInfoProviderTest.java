 ...
 */
public class FilteredScancodeV31ComponentInfoProviderTest {

  // the object under test
  FilteredScancodeV31ComponentInfoProvider filteredScancodeV31ComponentInfoProvider;
  ...
  public void setup() throws SolicitorMalformedPackageURLException {
    ...
    this.filteredScancodeV31ComponentInfoProvider = new FilteredScancodeV31ComponentInfoProvider(
