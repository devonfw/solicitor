...
public interface NormalizedLicense {
  ...
  /**
   * Gets the content referenced by {@link #getEffectiveNormalizedLicenseUrl()}
   *
   * @return the referenced content.
   */
  ...
  /**
   * Set the {@link ApplicationComponent} to which the {@link NormalizedLicense} belongs.
   *
   ...
   *
   * @param effectiveNormalizedLicenseUrl the new value of the field effectiveNormalizedLicenseUrl
   */
   ...
   *
   * @param normalizedLicenseType the new value of the field normalizedLicenseType
   */
   ...
   *
   * @param normalizedLicenseUrl the new value of the field normalizedLicenseUrl
   */
