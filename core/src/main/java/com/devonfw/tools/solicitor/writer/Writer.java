...
/**
 * A {@link Writer} creates a report from the given data using a specified
 * template.
 */
public interface Writer {

    /**
     * Determines if the {@link Writer} instance is capable of handling the
     * given template type.
     * 
     * @param type the template type
     * @return <code>true</code> if the writer is capable of handling this type,
     ...
     * @param dataTables a map of data table which contain the data to be used
     *        for the report
     */
