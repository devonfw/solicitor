...
public final class LicenseTextHelper {
    ...
    private static final String LARGE_HTML_CONTENT_PLACEHOLDER =
            "### Large HTML content which is not shown here - needs cleanup ###";
    ...
    /**
     * Replaces long raw html content with a short note that indicates the need
     * for some cleanup.
     *
     * @param rawContent the incoming content
     * @return the incoming content or the note if the incoming was a large html
     *         content
     */
