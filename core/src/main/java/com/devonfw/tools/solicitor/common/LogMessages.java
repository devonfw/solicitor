...
public enum LogMessages {
  ...
  READING_INVENTORY(11,
      "Reading {} ApplicationComponents / {} Licenses for Application '{}' from '{}'. All ApplicationComponents were added to the data model. UsagePattern set to {}, ossModified set to {}."), //
