...
/**
 * A factory for finding the appropriate {@link Reader} for the given data format.
 */
@Component
public class ReaderFactory {
   ...
   * @throws SolicitorRuntimeException if no appropriate {@link Reader} could be found
   */
