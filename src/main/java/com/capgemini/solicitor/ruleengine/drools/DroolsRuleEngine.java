...
import com.capgemini.solicitor.SolicitorSetup;
...
public class DroolsRuleEngine implements RuleEngine {
    ...
    private KieSession prepareSession() {
        ...
        ReleaseId rid = ks.newReleaseId("com.capgemini", "solicitor", "0.0.1");
        ...
        baseModel.addPackage("com.capgemini.solicitor.rules");
