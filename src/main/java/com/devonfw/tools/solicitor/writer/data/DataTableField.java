...
public interface DataTableField {
    ...
    /**
     * Possible states of the difference of the both values stored in this
     * object.
     */
    ...
    /**
     * Gets the old value. The existence of an old value is optional and only is
     * used when the difference of the results between two executions of
     * Solicitor is calculated.
     *
     * @return the old value stored in this object; <code>null</code> if no old
     *         value exists
     */
    Object getOldValue();
    ...
    /**
     * Sets the old value. Will automatically compute the resulting difference
     * status.
     *
     ...
     * {@inheritDoc}
     * 
     * Needs to return the value stored in this field as templating engines
     * (esp. Velocity) call the {@link #toString()} method to determine the
     * value to use of output.
     */
    @Override
    String toString();
