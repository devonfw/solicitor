...
public class ModelHelper {
   ...
   * the condition is inverted. The prefix "REGEX:" indicates that the remainder should be interpreted as a Java RegEx
   * and matching will be done against this RegEx. "RANGE:" indicates that the following should be interpreted as a
   * Maven version range expression.
   *
