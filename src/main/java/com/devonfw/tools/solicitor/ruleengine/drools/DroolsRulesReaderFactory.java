...
/**
 * A factory for getting the appropriate {@link DroolsRulesReader} for a given
 * rule type.
 */
@Component
public class DroolsRulesReaderFactory {
    ...
    /**
     * Returns the appropriate {@link DroolsRulesReader} for the given rule
     * type.
     *
     * @param type the name of the type
     * @return the right {@link DroolsRulesReader}
     * @throws SolicitorRuntimeException if no appropriate
     *         {@link DroolsRulesReader} is defined
     * 
     */
