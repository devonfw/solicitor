...
Copyright 2019 Capgemini SE - SPDX-License-Identifier: Apache-2.0
...
A more technical oriented view of _Solicitor_ is gviven below.
...
[listing]
  "writers" : [ {
    ...
    "dataTables" : { <5>
      "ENGAGEMENT"  : "classpath:com/capgemini/solicitor/sql/allden_engagements.sql",
      "LICENSE" : "classpath:com/capgemini/solicitor/sql/allden_normalizedlicenses.sql"
    }
  } ]
