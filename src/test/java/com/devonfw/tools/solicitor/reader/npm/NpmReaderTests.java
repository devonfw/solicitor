...
public class NpmReaderTests {
    ...
    private static final Logger LOG =
            LoggerFactory.getLogger(NpmReaderTests.class);
    ...
    public void testFindLicense() {
        ...
        boolean found = false;
        for (ApplicationComponent ap : lapc) {
            if (ap.getArtifactId().equals("tough-cookie") && ap.getRawLicenses()
                    .get(0).getDeclaredLicense().equals("BSD-3-Clause")) {
                found = true;
                break;
            }
        }
    ...
    public void testFindDiffrentLicense() {
        ...
        boolean found = false;
        for (ApplicationComponent ap : lapc) {
            if (ap.getArtifactId().equals("aws-sign2") && ap.getRawLicenses()
                    .get(0).getDeclaredLicense().equals("Apache-2.0")) {
                found = true;
                break;
            }
        }
    ...
    public void testFindDiffrentLicense2() {
        ...
        boolean found = false;
        for (ApplicationComponent ap : lapc) {
            if (ap.getArtifactId().equals("autoprefixer") && ap.getRawLicenses()
                    .get(0).getDeclaredLicense().equals("MIT")) {
                found = true;
                break;
            }
        }
    ...
    public void testFindDiffrentLicense3() {
        ...
        boolean found = false;
        for (ApplicationComponent ap : lapc) {
            if (ap.getArtifactId().equals("yargs")
                    && ap.getVersion().equals("9.0.1") && ap.getRawLicenses()
                            .get(0).getDeclaredLicense().equals("MIT")) {
                found = true;
                break;
            }
